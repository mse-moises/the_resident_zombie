...
void main() {
  ...
  group('User repository test:', () {
    ...
    final tUserModel = UserModel(id:'test',name: tName, age: tAge, gender: tGender, infected:false);
    ...
    group(
      'Get local user -',
      () {
        final tUser = UserModel(id:'test',name:'test',age:30,gender:'t', infected:false);
        test(
          'return a [UserEntity]',
          () async {
            // arrange
